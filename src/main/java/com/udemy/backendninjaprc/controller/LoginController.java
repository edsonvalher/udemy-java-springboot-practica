...
public class LoginController {
    ...
    /*
     * @GetMapping("/") public RedirectView redirectToLogin() {
     * LOG.info("METHOD: redirectToLogin()"); return new RedirectView("/login"); }
     */
    @GetMapping("/login")
    ...
    public String loginCheck() {
        ...
        LOG.info("Returning to contacts views");
